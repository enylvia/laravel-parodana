...
@section('content')
	...
	<div class="box">		
		...
		<div class="box-body">
			<a href="{{URL::to('/installment/printAll/' .$loanNumber)}}" class="btn btn-sm btn-success" target="_blank">
				Cetak Semua
			</a>
			<div class="table-responsive">
				...
				<table class="table table-responsive table-striped">
					...
					@foreach($loans as $loan)
					<?php 
						$angsurans = App\Models\Installment::where('loan_number',$loan->loan_number)->orderBy('due_date','asc')->orderBy('inst_to','asc')->get();
					?>
		...
		<div class="box-footer">
			...
			<a href="{{URL::to('/installment/printAll/' .$loanNumber)}}" class="btn btn-default btn-md">
