...
<meta name="_token" content="{!! csrf_token() !!}"/>
    ...
    <div class="row">
    <form action="{{ url('/menu/management/store') }}" method="POST" enctype="multipart/form-data">
      {{ csrf_field() }}
        <div class="col-md-5">
        	<div class="box box-solid">
	            <div class="box-header with-border">
	...
	<div id="Edit-{{$item->id}}" class="modal fade" role="dialog">
	  <div class="modal-dialog modal-lg">
	    ...
	    <form class="form-horizontal" role="form" method="POST" action="{{ url('/menu/management/update', $item->id) }}">
	      {{ csrf_field() }}
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	            ...
	            <div class="input-group">
	                <span class="input-group-addon"><i class="fa fa-list"></i></span>
	                <input type="text" class="form-control" name="name" value="{{$item->display}}">
	            </div>
	            <div class="input-group">
	                <span class="input-group-addon"><i class="fa fa-list"></i></span>
	...
	<div id="Hapus-{{$item->id}}" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	    <form class="form-horizontal" role="form" method="GET" action="{{ url('/menu/management/delete', $item->id) }}">
	      {{ csrf_field() }}
	    <!-- Modal content-->
	    <div class="modal-content">
	      <div class="modal-header">
