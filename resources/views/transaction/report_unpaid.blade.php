    ...
    <div class="card shadow p-3 mb-5 bg-white rounded" id="btn-cetak">
        <div class="card-body">
            <table class="" width="100%">
                ...
                <tr>
                    <td colspan="4" class="py-5" style="line-height: 100%;">
                        <div class="" style="text-align:center;">
                            <p>LAPORAN ANGSURAN TAK TERTAGIH PER
                                {{ Carbon\Carbon::parse(request()->input('date_trx'))->format('d F Y') }}</p>
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <div class="text-end py-3" id="action">
                <a href="/transaction/report" class="btn btn-sm btn-primary">Close</a>
                <a href="{{ request()->url() }}?{{ request()->getQueryString() }}&page=paid"
