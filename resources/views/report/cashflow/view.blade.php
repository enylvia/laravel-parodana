		...
		<div class="box-body">
			...
			<h4>Total Data : <strong>{{ $total_neraca }}</strong> </h4>
				<table class="table table-striped text-center">
					<caption class="text-center"> <strong>ARUS KAS</strong></caption>
					<tr>
					...
					<tr>
						...
						<td>
						  ...
						  <a href="{{ url('report/cashflow/print/'.date('Y-m-d', strtotime('1-'.$data->waktu))) }}" class="btn btn-warning" target="_blank">
							Cetak
						  </a>
						</td>
					</tr>
