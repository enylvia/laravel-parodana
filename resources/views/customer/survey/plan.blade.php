			...
			<div class="col-md-3">
				<div class="box box-primary box-outline">
					<div class="box-body box-profile">
						...
						<ul class="list-group list-group-unbordered mb-3">
							...
							<li class="list-group-item">
								<b>{{trans('survey.time_period')}}</b> <a class="float-right">{{$customer->time_period}} {{trans('general.month')}}</a>
							</li>
							<li class="list-group-item">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<p class="text-muted">
						{{!empty($religion->name)  ? $religion->name : ''}}
						</p>
						...
						<p class="text-muted">
						{{$customer->address}}, {{!empty($kelurahan->nama) ? $kelurahan->nama : ''}} {{$customer->zip_code}}, 
						{{!empty($kecamatan->nama) ? $kecamatan->nama : ''}} {{!empty($kabupaten->nama) ? $kabupaten->nama : ''}}, 
						{{!empty($provinsi->nama)  ? $kecamatan->nama : ''}}
						</p>
					</div>
				</div>
			</div>
					...
					<div class="box-body">
						<div class="tab-content">
							...
							<div class="tab-pane" id="maritial_status" disabled>
								...
								<div class="box-body">
									<div class="form-group col-sm-4">
										...
										<input name="maritial" class="form-control" id="maritial" type="text" value=" {{!empty($maritial->name) ? '' : '$maritial->name'}}">
									</div>					
									<div class="form-group col-sm-4">
								...
								<div class="box-body">
									...
									<div class="form-group col-sm-4">
										...
										<!--select class="form-control" id="family_connection" name="family_connection">
											...
											<option value="4">Rekan Kerja</option>
										</select-->
									</div>				
								</div>
							</div>
							...
							<div class="tab-pane" id="approve">
								<form method="post" action="{{URL::to('/survey/plan/update', $customer->id)}}" enctype="multipart/form-data">
								{{ csrf_field() }}
								<div class="box-header">
								...
								<div class="box-body">
									<div class="form-group col-sm-4">
										...
										<select class="form-control" id="approve" name="approve" required>
											<option value="0">Please select</option>
											<option value="Approve Manager">Approve</option>
											<option value="UnApprove Manager">UnApprove</option>
										</select>
									</div>
									<div class="form-group col-md-12">
										<label class="control-label" for="title">{{trans('survey.note')}}</label>
